...
pacman::p_load(vmstools, sf, data.table, raster, terra, mapview, Matrix, dplyr, 
               ...
               tidyverse, units, tcltk, lubridate, here, dplyr, lubridate)


# Set paths
path <- paste0(getwd(), "/") # Working directory
data_path <- paste0('Y:\\FISHERIES M MoU\\Working_Area\\spatial_fisheries_data\\ices_datacalls\\ices_vms_lb_datacall_2024\\data') # Data  directory
...
overlap_trips =   function  ( eflalo_df  ) { 
  ...
  ## ifelse has a probelm with the date formats , so it is used REPLACE function instead
